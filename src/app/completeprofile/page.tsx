                  ...
                  {["Full-Time", "Part-Time", "Distance Learning"].map(
                    (mode) => (
                      <label key={mode} className="flex items-center gap-2">
                        <input
                          type="checkbox"
                          checked={formData.B.modeOfOperation.includes(mode)}
                          onChange={() =>
            ...
            <div className="space-y-4 text-sm">
                  ...
                  {[
                    ...
                    <label key={option} className="flex items-center gap-2">
                      <input
                        type="radio"
                        value={option}
                        checked={formData.C.licenceStatus === option}
                        onChange={() => {
                          setFormData((prev) => ({
                            ...prev,
                            C: {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className={`p-2 border rounded ${
                      formData.C.prevLicence === "No"
                        ? "bg-gray-100 cursor-not-allowed"
                        : ""
                    }`}
                    disabled={formData.C.prevLicence === "No"} // ✅ disable when No
                  />
                </div>
                  ...
                  {["Yes", "No"].map((option) => (
                    <label key={option} className="flex items-center gap-2">
                      <input
                        ...
                        value={option}
                        checked={formData.C.outstandingPenalties === option}
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            C: {
              ...
              <div className="flex flex-col gap-2 md:col-span-2">
                ...
                <input
                  ...
                  value={formData.C.penalty}
                  onChange={(e) => handleChange("D", "penalty", e.target.value)}
                  className={`p-2 border rounded ${
                    formData.C.outstandingPenalties === "No"
                      ? "bg-gray-100 cursor-not-allowed"
                      : ""
                  }`}
                  disabled={formData.C.outstandingPenalties === "No"} // ✅ disable when No
                />
              </div>
            </div>
          )}
