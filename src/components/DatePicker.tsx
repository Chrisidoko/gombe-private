  ...
  return (
    <div
      ...
      className={cx(
        ...
        {
          "!w-fit border-none bg-transparent px-0 text-gray-600 shadow-none":
            isDecorator,
          hidden: isSpace,
          "border-gray-300 bg-gray-100 text-gray-400": state.isDisabled,
          "!bg-transparent !text-gray-600": !segment.isEditable,
        },
      )}
    >
      <span
...
const PresetContainer = <TPreset extends Preset, TValue>({
  ...
  const isDateRangePresets = (preset: unknown): preset is DateRangePreset => {
    return (
      typeof preset === "object" && preset !== null && "dateRange" in preset
    );
  };
          ...
          <li key={index} className="sm:w-full sm:py-px">
            <button
              ...
              className={cx(
                ...
                "hover:bg-gray-900",
                {
                  "bg-gray-50": matchesCurrent(preset),
                },
              )}
